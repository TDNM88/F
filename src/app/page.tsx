...
import TradingViimport { useEffect, useState } from "react";
import { motion } from "framer-motion";
...
function ChartTabs() {
  // Hooks for active tabs could be implemented here
  ...
  return (
    <div className="flex flex-col w-full px-1 sm:px-0" style={{ marginBottom: "24px" }}>
      ...
      >
        {/* Chart placeholder - to be replaced with actual chart */}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="mb-6 bg-cover bg-center bg-no-repeat rounded-lg w-full"
            style={{
          ...
          <div style={{ padding: "16px" }}>
            ...
            >
              Sàn giao dịch chứng khoán London (HSC) là sàn giao dịch chứng khoán chính ở Vương quốc Anh và lớn nhất
              ở châu Âu. Thành lập chính thức từ năm 1773, các sàn giao dịch khu vực được sáp nhập vào năm 1973 để
              hình thành nên Sàn giao dịch chứng khoán Vương quốc Anh và Ireland, sau đó đổi tên thành Sàn giao dịch
              chứng khoán London (HSC).
            </p>
          </div>
        ...
        >
          <div style={{ padding: "16px" }}>
            ...
            >
              Sàn giao dịch chứng khoán London HSC chào đón Thống đốc Samuel Garcia từ Nuevo León, Mexico
            </h2>
            <p
              style={{
                fontSize: "14px",
            ...
            >
              Sàn giao dịch chứng khoán London HSC rất hân hạnh được chào đón Thống đốc Samuel García và đoàn đại biểu
              danh dự của ông từ Tiểu bang Nuevo León, Mexico. Chuyến thăm này đánh dấu một cột mốc quan trọng trong
              việc củng cố mối quan hệ kinh tế giữa Vương quốc Anh và một trong những khu vực năng động và có tư duy
          ...
          <div style={{ padding: "16px" }}>
            ...
            >
              HSC là sàn giao dịch chứng khoán quốc tế nhất với hàng ngàn công ty từ hơn 60 quốc gia và là nguồn hàng
              đầu của tính thanh khoản thị trường vốn, giá chuẩn và dữ liệu thị trường ở châu Âu. Có các quan hệ đối
              tác với các sàn giao dịch quốc tế ở châu Á và châu Phi, SSI dự định loại bỏ các rào cản về chi phí và các
              qui định khỏi thị trường vốn trên toàn thế giới.
            </p>
          </div>
          {/* FTSE widget */}
          <div
          ...
          >
            ...
            <div
              style={{ fontSize: "24px", fontWeight: "bold", color: "rgba(0, 0, 0, 0.85)" }}
            >
              8,786.3
              <span
                style={{ fontSize: "14px", color: "rgba(0, 0, 0, 0.45)", marginLeft: "4px" }}
              >
                GBP
              </span>
            </div>
      ...
      <div className="w-full overflow-x-hidden">
        <div
          className="mx-auto"
          style={{ userSelect: "none", boxSizing: "border-box", display: "block", width: "100%", maxWidth: "1028px" }}
        >
...
}ewTickerTape from "@/components/TradingViewTickerTape";
import Footer from "@/components/Footer";
